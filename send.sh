...
read -e -p "What directory from your local system are you uploading into AWS S3? Please enter the absolute path and escape any spaces if necessary: " sourceLocalDirectory
